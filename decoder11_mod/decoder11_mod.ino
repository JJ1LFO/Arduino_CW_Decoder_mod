...
*
*
* Copyright (C) 2014 Hjalmar Skovholm Hansen OZ1JHM
* Copyright (C) 2024 Sho Ikeda JJ1LFO
*
...
//--------------------------------------------------------------------
#if	defined(USE_BOARD_OZ1JHM_ORIGINAL)
...
//--------------------------------------------------------------------
#if defined(USE_PARAMETERS_OZ1JHM_ORIGINAL)
...
int testData[NUMOF_TESTDATA];
float n=sizeof(testData)/sizeof(testData[0]);		///JJ1LFO///	=48.0;
...
#ifdef	USE_MEASURE_SAMPLING_FREQ			///JJ1LFO/// 
